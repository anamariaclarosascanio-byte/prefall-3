/**
 * Route-specific OG image for /jobs. Renders a branded "job board"
 * creative so social shares of pre-fall.com/jobs land with a
 * contextual preview instead of the generic homepage hero.
 *
 * Doubles as a re-usable announcement asset for LinkedIn / Substack
 * posts — downloadable directly from the OG URL.
 *
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            A weekly edit of openings at the brands and houses shaping the
